...
async def send_alive_message(message: Message) -> None:
    ...
    if client.is_bot:
        ...
        caption += (
            ...
            "    <code>|</code>    "
            "👥  <a href='https://t.me/esoterikx'><b>SUPORTE</b></a>"
        )
...
if userge.has_bot:
    ...
    async def alive_cb(_, c_q: CallbackQuery):
        ...
        if Config.HEROKU_APP and Config.RUN_DYNO_SAVER:
            alive_s += "⛽️ 𝗗𝘆𝗻𝗼 𝗦𝗮𝘃𝗲𝗿 :  ✅ Habilitado\n"
...
class Bot_Alive:
    ...
    def alive_info() -> str:
        alive_info_ = f"""
<a href="https://t.me/esoterikx"><b>Excalibur</a> está ativo e a todo vapor!</b>

  🐍   <b>Python :</b>    <code>v{versions.__python_version__}</code>
  🔥   <b>Pyrogram :</b>    <code>v{versions.__pyro_version__}</code>
  🧬   <b>Excalibur :</b>    <code>v{get_version()}</code>
...
"""
    ...
    def alive_buttons() -> InlineKeyboardMarkup:
        buttons = [
            [
                InlineKeyboardButton(text="🔧  OPÇÕES", callback_data="settings_btn"),
